...
def test_process_demo():
    ...
    try:
        ...
        if result != RobotErrorType.RobotError_SUCC:
            ...
            robot.init_profile()
            joint_maxvelc = (2.596177/12, 2.596177/12, 2.596177/12, 3.110177/12, 3.110177/12, 3.110177/12)
            ...
            while True:
                ...
                joint_radian = (1.570800, 0.225068, -0.948709, 0.397018, -1.570800, 0.541673)
                robot.add_waypoint(joint_radian)  # 添加路点 1


                joint_radian = (55.5/180.0*pi, -20.5/180.0*pi, -72.5/180.0*pi, 38.5/180.0*pi, -90.5/180.0*pi, 55.5/180.0*pi)
                robot.add_waypoint(joint_radian)  # 添加路点 2


                joint_radian = (0, 0, 0, 0, 0, 0)
                robot.add_waypoint(joint_radian)  # 添加路点 3
                robot.move_track(RobotMoveTrackType.CARTESIAN_MOVEP)  # 机械臂轨迹运动
